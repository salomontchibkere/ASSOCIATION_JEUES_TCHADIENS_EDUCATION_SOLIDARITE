...
export async function seedInitialData() {
  ...
  const initialProjects: Project[] = [
    ...
    {
      id: cryptoUUID(),
      titleFr: 'Distribution de fournitures scolaires aux élèves du CEG',
  ...
  const initialNews: News[] = [
    {
      id: cryptoUUID(),
      titleFr: 'Inauguration officielle du bureau administratif du CEG',
      contentFr: 'L\'Association des Jeunes Tchadiens pour l\'Éducation et la Solidarité (AJTES) annonce la finalisation et l\'inauguration du nouveau bureau administratif de deux chambres au CEG. Un grand pas vers de meilleures conditions d\'apprentissage !',
      category: 'ACTUALITE',
      published: true,
