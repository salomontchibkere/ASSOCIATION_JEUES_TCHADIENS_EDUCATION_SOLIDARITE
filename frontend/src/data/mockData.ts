...
export const initialUsers: User[] = [
  ...
  },
  {
    ...
    password: 'MarcAllan#Ajtes2026!Sec',
    role: 'super_admin',
  ...
  },
  {
    ...
    password: 'Valentin#Ajtes2026!Sec',
    role: 'super_admin',
    profession: 'Secrétaire Général & Administrateur (Pouvoir Complet 100%)',
    phone: '63373639',
    city: 'N\'Djamena',
    memberType: 'actif',
    membershipStatus: 'actif',
  ...
  },
  {
    ...
    password: 'SoumaBanak#Ajtes2026!Sec',
    role: 'super_admin',
    profession: 'Président de l\'AJTES (Pouvoir Complet 100%)',
    phone: '+237690969577',
    city: 'N\'Djamena',
    memberType: 'actif',
    membershipStatus: 'actif',
  ...
  },
  {
    ...
    password: 'Boikoussigue#Ajtes2026!Sec',
    role: 'super_admin',
    profession: 'Chargé de Communication & Administrateur (Pouvoir Complet 100%)',
    phone: '65031849',
    city: 'N\'Djamena',
    memberType: 'actif',
    membershipStatus: 'actif',
